  ...
  return (
    <nav className="grid items-start xl:ml-5 md:ml-5 gap-2">
      ...
      <Link href="/principal/admins">
        <Button
          variant={pathname.includes("/principal/admins") ? "secondary" : "ghost"}
      ...
      <Link href="/principal/students">
        <Button
          variant={pathname.includes("/principal/students") ? "secondary" : "ghost"}
          className="w-full justify-start cursor-pointer"
        >
      ...
      <Link href="/principal/fees">
        <Button
          variant={pathname.includes("/principal/fees") ? "secondary" : "ghost"}
          className="w-full justify-start cursor-pointer"
        >
