    ...
    <DashboardShell sidebar={<TeacherNav />} title="View Attendance">
      ...
      {isLoading ? (
        ...
        <Card>
          ...
          <CardContent>
            <Link href="/teacher/attendance">
              <Button className="cursor-pointer">Back to Attendance</Button>
            </Link>
          </CardContent>
        </Card>
        </div>
        ...
        <Card className="mb-6">
          <CardHeader className="flex flex-row items-start justify-between">
            ...
            <div className="flex gap-2">
              {isEditing ? (
                <>
                  <Button variant="outline" className="cursor-pointer" onClick={() => setIsEditing(false)} disabled={isSubmitting}>
                    Cancel
                  </Button>
                  <Button onClick={handleSaveChanges} className="cursor-pointer" disabled={isSubmitting}>
                    {isSubmitting ? "Saving..." : "Save Changes"}
                  </Button>
                </>
              ) : (
                <>
                  <Button variant="outline" className="cursor-pointer" onClick={() => setIsEditing(true)}>
                    Edit
                  </Button>
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      ...
                      <AlertDialogFooter>
                        ...
                        <AlertDialogAction onClick={handleDeleteSession} className="cursor-pointer" disabled={isSubmitting}>
