...
export default function NewAnnouncementPage() {
  ...
  return (
    <DashboardShell sidebar={<AdminNav />} title="New Announcement">
      ...
      <Card className="max-w-3xl">
        <form onSubmit={handleSubmit}>
          ...
          <CardFooter className="flex mt-5 gap-2 justify-between">
            <Button type="button" variant="outline" className="cursor-pointer" onClick={() => router.push("/admin/announcements")}>
              Cancel
            </Button>
