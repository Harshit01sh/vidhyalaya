...
export default function ExamTimetableDetailsPage() {
  ...
  if (isLoading) {
    return (
      <DashboardShell sidebar={<AdminNav />} title="Exam Timetable Details">
  ...
  if (!timetable) {
    return (
      <DashboardShell sidebar={<AdminNav />} title="Exam Timetable Not Found">
  ...
  return (
    <DashboardShell sidebar={<AdminNav />} title="Exam Timetable Details">
      ...
      <div className="flex justify-between items-center p-3 mb-6">
        ...
        <Link href={`/admin/exams/edit/${timetable.id}`}>
